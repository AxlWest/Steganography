...
ImageFile* LSB_2_0_0::proformSteganography(ImageFile* image , const char *messagePathway)
{
    FILE* file = NULL ;
    unsigned int k = 0 ;
...
void LSB_2_0_0::extractSteganography(ImageFile* image , const char *messageFileName)
{
    FILE* file = NULL ;
    unsigned char* textData = NULL ;
    unsigned char* imageData = NULL ;
...
void LSB_2_0_0::addEnding(ImageFile *image , int k)
{
    //=<END!>=
